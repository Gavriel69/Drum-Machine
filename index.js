...
// Sound libraries
//      First Library
oneQ = new sound('./sounds/BD_MF_Valve12.wav');
oneW = new sound('./sounds/BellDull_MF_Valve1.wav');
oneE = new sound('./sounds/Conga_MF_Valve1.wav');
oneA = new sound('./sounds/HH_MF_Valve12.wav');
oneS = new sound('./sounds/Perc_MF_LastValve1.wav');
oneD = new sound('./sounds/SD_MF_Layered3.wav');
oneZ = new sound('./sounds/Tom_MF_Valve4.wav');
oneX = new sound('./sounds/Wood_MF_Valve_D#4.wav');
oneC = new sound('./sounds/Zap_MF_Valve2.wav');
...
//      Second Library
twoQ = new sound('./sounds/BD_MF_Valve11.wav');
twoW = new sound('./sounds/BellDull_MF_Valve2.wav');
twoE = new sound('./sounds/Conga_MF_Valve5.wav');
twoA = new sound('./sounds/HH_MF_Valve15.wav');
twoS = new sound('./sounds/Perc_MF_Valve33.wav');
twoD = new sound('./sounds/SD_MF_Layered8.wav');
twoZ = new sound('./sounds/Tom_MF_Valve3.wav');
twoX = new sound('./sounds/Wood_MF_Valve_C#4.wav');
twoC = new sound('./sounds/Zap_MF_Valve4.wav');
...
//      Third Library
threeQ = new sound('./sounds/BD_MF_Valve14.wav');
threeW = new sound('./sounds/Conga_MF_Valve3.wav');
threeE = new sound('./sounds/HHo_MF_Valve1.wav');
threeA = new sound('./sounds/Metal_MF_Valve18.wav');
threeS = new sound('./sounds/Perc_MF_Valve37.wav');
threeD = new sound('./sounds/Timp_MF_Valve1.wav');
threeZ = new sound('./sounds/Tom_MF_Valve1.wav');
threeX = new sound('./sounds/Wood_MF_Valve_G#4.wav');
threeC = new sound('./sounds/Zap_MF_Valve1.wav');
